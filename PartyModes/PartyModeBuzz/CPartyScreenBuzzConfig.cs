...
{
    public class CPartyScreenBuzzConfig : CPartyScreenChallenge
    // ReSharper restore UnusedMember.Global
    {
        ...
        private const string _SelectSlidePreview = "SelectSlidePreview";
        private const string _SelectSlideNumChoices = "SelectSlideNumChoices";
        ...
        public override void Init()
        {
            ...
            _ThemeSelectSlides = new string[] { _SelectSlideNumPlayers, _SelectSlideNumMics, _SelectSlideNumRounds, _SelectSlidePreview, _SelectSlideNumChoices };
        ...
        private void _RebuildSlides()
        {
            ...
            _SelectSlides[_SelectSlidePreview].Clear();
            _SelectSlides[_SelectSlidePreview].AddValue(CBase.Language.Translate("TR_BUTTON_NO", PartyModeID));
            _SelectSlides[_SelectSlidePreview].AddValue(CBase.Language.Translate("TR_BUTTON_YES", PartyModeID));
            _SelectSlides[_SelectSlidePreview].SelectLastValue();

            _SelectSlides[_SelectSlideNumChoices].Clear();
            for (int i = 2; i <= 4; i++)
                _SelectSlides[_SelectSlideNumChoices].AddValue(i);
            _SelectSlides[_SelectSlideNumChoices].SelectLastValue();
        }
        ...
        private void _UpdateSlides()
        {
            ...
            _PartyMode.GameData.Preview = (_SelectSlides[_SelectSlidePreview].Selection == 1);
            _PartyMode.GameData.NumChoices = _SelectSlides[_SelectSlideNumChoices].Selection + 2;
            _UpdateMicsAtOnce();
            _SetRoundSteps();
