...
namespace VocaluxeLib.PartyModes.ChallengeRounds
{
    ...
    public abstract class CPartyScreenChallengeRounds : CMenuParty
    {
        protected new CPartyModeChallengeRounds _PartyMode;

        public override void Init()
        {
            base.Init();
            _PartyMode = (CPartyModeChallengeRounds)base._PartyMode;
        }
    }

    // ReSharper disable ClassNeverInstantiated.Global
    public sealed class CPartyModeChallengeRounds : CPartyMode
        // ReSharper restore ClassNeverInstantiated.Global
    {
        ...
        public CPartyModeChallengeRounds(int id) : base(id)
        {
        ...
        private IMenu _GetNextScreen()
        {
            ...
            {
                case EStage.Config:
                    return _Screens["CPartyScreenChallengeRoundsConfig"];
                case EStage.Names:
                    return _Screens["CPartyScreenChallengeRoundsNames"];
                case EStage.Main:
                    return _Screens["CPartyScreenChallengeRoundsMain"];
                case EStage.Singing:
