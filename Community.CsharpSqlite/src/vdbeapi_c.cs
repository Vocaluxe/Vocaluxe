...
*/
    ...
    */
    ...
    // return raw bytes (for CP1252 coded strings)
    public static byte[] sqlite3_value_rawbytes(sqlite3_value pVal)
    {
        Mem p = pVal;
...
*/
    ...
    */
    ...
    public static byte[] sqlite3_column_rawbytes(sqlite3_stmt pStmt, int i)
    {
        byte[] val;
        val = sqlite3_value_rawbytes(columnMem(pStmt, i));
        /* Even though there is no encoding conversion, value_blob() might
        ** need to call malloc() to expand the result of a zeroblob()
        ** expression.
        */
