...
namespace DiffieHellman
{
    ...
    /// </summary>
    public class CDiffieHellman : IDisposable
    {
        #region - Util -
        ...
        #region - Ctor -
        public CDiffieHellman()
        {
        }

        public CDiffieHellman(int bits)
        {
            this.bits = bits;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public CDiffieHellman GenerateRequest()
        {
        ...
        /// <returns></returns>
        public CDiffieHellman GenerateResponse(string request)
        {
