...
namespace Vocaluxe.Lib.Sound.Record.PitchTracker
{
    ...
    abstract class CPitchTracker : IDisposable
    {
        ...
        /// <param name="weights">Array of NumHalfTones floats that gets filled with the current weights (0-1) where each value indicates how strong that tone is.
        /// Only for basic visualization as it may not be accurate.</param>
