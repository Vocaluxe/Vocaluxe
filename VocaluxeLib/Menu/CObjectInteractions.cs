...
namespace VocaluxeLib.Menu
{
    public abstract class CObjectInteractions
    {
        ...
        protected readonly COrderedDictionaryLite<CRatingPopup> _RatingPopups;
        ...
        protected CObjectInteractions()
        {
            ...
            _RatingPopups = new COrderedDictionaryLite<CRatingPopup>(this);
        }
        ...
        protected void _AddRatingPopup(CRatingPopup rp, String key = null)
        {
            _AddElement(_RatingPopups.Add(rp, key), EType.RatingPopup);
        }
